...
public class Main {
       ...
       * a dealership ID, and attempts to find the corresponding Dealership
       ...
       * @return The index of the object if a valid ID is entered, or
       ...
       * and a {@link FileIO} object. If the file cannot be opened (e.g., file not found, invalid
      ...
      /**
       * Writes data to the JSON file contained by {@link FileIO} object.
       * <p>
       * This method opens a JSON file contained in {@link FileIO} object
